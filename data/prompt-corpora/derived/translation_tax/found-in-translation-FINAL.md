...
*Category: user-experience · 11 min read · draft — July 2026*
...
**Subtitle (Substack):** Search taught us to strip the grammar from our thoughts. Conversation gave it back.
**Subtitle (website):** What 357,000 prompts reveal about the language we only ever spoke for the machine.
**Read time:** 11 min read (2,430 words ÷ 225, computed at voice pass; identical both channels)
**Slug:** found-in-translation

### articles.json block (Chat fills all but id/date/related — Code owns those three)
...
```json
{
  ...
  "slug": "found-in-translation",
  "title": "Found in translation",
  "subtitle": "What 357,000 prompts reveal about the language we only ever spoke for the machine.",
  "category": "user-experience",
  "date": "2026-07-XX",
  "readTime": "11 min read",
  "excerpt": "For twenty-five years we compressed our intentions into keywords so a search engine could parse them. Then conversational software removed the constraint — and 357,000 real messages show what people do when they no longer have to translate. A measurement of the translation tax, and its refund.",
  "coverImage": "",
  "hosting": "local",
  "substackUrl": null,
  "related": ["repriced-overnight", "SLUG_2", "SLUG_3"],
  "bodyHtml": "GENERATED_BY_CODE_FROM_MD"
}
```

Note for Code: website `subtitle` field uses the discovery-reader variant above (not the Substack line). Interactive embeds handled per the separate website-build brief — do not inline the widget JS into `bodyHtml`.
